...
export default function FavoritesScreen() {
  const { favorites, fetchFavorites, isLoading } = useCharacterStore();
      ...
      >
        {!isLoading && favorites.length === 0 ? (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>You haven't favorited any characters yet.</Text>
            <TouchableOpacity style={styles.createButton} onPress={() => router.push('/(tabs)/discover' as any)}>
              <Text style={styles.createButtonText}>Discover</Text>
            </TouchableOpacity>
          </View>
        ) : (
